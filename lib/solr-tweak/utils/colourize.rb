...
# Mixes in a bunch of colour methods to String.
# This can be surprisingly useful for making CLI scripts
# readable and debuggable.
#
# You probably don't need 90+ of them though...
#
# These wont work on Windows consoles (you'll see the escape characters)
# For cross platform command line colorization see the Highline Gem
